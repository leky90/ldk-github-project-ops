...
export function validateLegacyProjectBinding(binding) {
  const errors = [];
...
export function validateLegacyWorkPlan(plan, { binding, forApply = false } = {}) {
  const errors = [];
...
export function validateLegacyHandoff(handoff) {
  const errors = [];
...
export function validateLegacyProjectUpdate(update, { forPublish = false } = {}) {
  const errors = [];
...
export function renderLegacyHandoff(handoff) {
